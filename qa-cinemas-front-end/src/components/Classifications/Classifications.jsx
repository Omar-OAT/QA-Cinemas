...
const Classifications = () => {
    return ( 
        <div>
            ...
            <h3> This page is dedicated to providing you with information regarding the different age classifications for our movies. If there is any more information you require, please visit the 'Contact Us' page of this website. </h3>
        ...
        <table className='ClassTable'>
            <tr>
                ...
                <tr>
                    ...
                    <td> Suitable for ages 12 and over, children under the age of 12 to be accompanied by an adult </td>
                </tr>
                <tr>
            ...
            <h3> Please use the below links for any additional information you might require regarding the specific Movie Classifications: </h3>
            <a target='_blank' href="https://www.bbfc.co.uk/about-classification">British Board of Film Classification</a><br></br>
            <a target='_blank' href="https://www.motionpictures.org/film-ratings/">Motion Pictures</a><br></br>
            <a target='_blank' href="https://parentpreviews.com/movie-ratings/uk">Parent Previews</a><br></br>
